package com.example.facedetection.facedetection
...
class FaceDetectionActivity : AppCompatActivity(), FrameProcessor {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.content_face_detection)
//        setSupportActionBar(toolbar)
    ...
    override fun process(frame: Frame) {
        ...
        //performContourDetection(frame)
        performFaceClassification(frame)
    }

    private fun performFaceClassification(frame: Frame) {
        ...
        faceDetector.detectInImage(firebaseVisionImage)
                .addOnSuccessListener {
                    ...
                    for (face in it) {
                        ...
                        canvas.drawText("Face", (face.boundingBox.centerX() - face.boundingBox.width() / 2) + 8F, (face.boundingBox.centerY() + face.boundingBox.height() / 2) - 8F, faceTextPaint)
                        ...
                        Log.d("TEST", "Eye Open probabiity " + face.leftEyeOpenProbability)
                    }
    ...
    private fun performContourDetection(frame: Frame) {
        val width = frame.size.width
        val height = frame.size.height
